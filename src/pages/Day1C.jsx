...
import '../styles/Day1C.css'

export default function Day1C() {
  return (
    <div>
      <body>
        <div className="container">
          <div className="intro-content">
            ...
            <p>
              ...
              unde rerum, deleniti ea obcaecati sint hic odit dicta tenetur qui
              ut dolorum provident sit, atque, reprehenderit nulla voluptate!
            ...
            <p>
              ...
              blanditiis veritatis expedita totam vel voluptatem officiis
            ...
            <p>
              ...
              assumenda mollitia aspernatur at saepe nisi commodi natus
              excepturi voluptate. Recusandae nisi dolorem, necessitatibus optio
